...
const Tooltip = _ref => {
  ...
  return /*#__PURE__*/reactDom.createPortal( /*#__PURE__*/React__default["default"].createElement(Core, {
    active: active || hover,
    parent: parent,
    offset: offset,
    position: position,
...
const Core = _ref2 => {
  ...
  const [positionState, setPosition] = React.useState({
    top: 0,
    left: 0
  });
...
Tooltip.propTypes = {
  ...
  parent: PropTypes__default["default"].instanceOf(HTMLElement).isRequired,
  children: PropTypes__default["default"].node.isRequired,
  offset: PropTypes__default["default"].number,
  position: PropTypes__default["default"].oneOf(['top', 'left', 'bottom', 'right']),
  tipStyle: PropTypes__default["default"].object,
